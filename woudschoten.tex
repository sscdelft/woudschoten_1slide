...
\definecolor{LDtextborder}{HTML}{EAE6D1}
...
% content
% 
\begin{textbox}(siam) at ($(current page.north west)+(3cm,-28cm)$) [below right] <60cm>
{}
\LARGE{
        \begin{itemize}
              \item The first SIAM Student Chapter in The Netherlands
              \item Promote research
...
{\animategraphics[autoplay,loop,width=40cm]{0.2}{photos/resized-photo-}{01}{13}};
